...
export module EncodeUtils {
  ...
  export function encode_msg_total_length(i: number, buf: number[]) {
    buf.push(i & 0xff);
    buf.push((i >> 8) & 0xff);
    buf.push((i >> 16) & 0xff);
    buf.push((i >> 24) & 0xff);
  ...
  export function uInt32ToByte(this: any, i: any, buf: any) {
    this.int32ToByte(i, buf);
  }
  export function int64ToByte(this: any, i: number, buf: number[]) {
    // if (!i) return
  ...
  export function uInt8ToByte(this: any, u: number, buf: any) {
    this.int8ToByte(u, buf);
  }

  ////////////////////////////////////////////////////////////////////////////////////////
  //解码
  export function byteToString(this: any, buf: any, index: number) {
  ...
  export function ByteToint32(buf: any, index: number) {
    let value = 0;
    if (Endian.instance.bigEndian) {
      value =
        ((buf[index] & 0xff) << 24) |
  ...
  export function ByteTouInt32(this: any, buf: any, index: any) {
  ...
  export function ByteToint64(this: any, buf: any, index: number) {
    let h = 0;
    let l = 0;
    let flag = 1;
    if (Endian.instance.bigEndian) {
  ...
  export function ByteTouInt8(buf: any, index: string | number) {
