...
import { NetPacket } from "@/netBase23/NetPacket";
...
export module MessageMapRegister {
	export function register() {
		...
		MessageMap.addMsgMap(NetPacket.shz_item);
		MessageMap.addMsgMap(NetPacket.req_shz_lottery);
		MessageMap.addMsgMap(NetPacket.notify_shz_lottery_result);
		MessageMap.addMsgMap(NetPacket.req_shz_bibei);
		MessageMap.addMsgMap(NetPacket.notify_shz_bibei_result);
		MessageMap.addMsgMap(NetPacket.req_shz_mali);
		MessageMap.addMsgMap(NetPacket.notify_shz_mali_result);
		MessageMap.addMsgMap(NetPacket.room_table);
		MessageMap.addMsgMap(NetPacket.req_table_list);
		MessageMap.addMsgMap(NetPacket.notify_table_list);
		...
		MessageMap.addMsgMap(NetPacket.req_enter_room_with_room_id);
		MessageMap.addMsgMap(NetPacket.notify_room_with_room_id_result);
		MessageMap.addMsgMap(NetPacket.req_change_room);
		MessageMap.addMsgMap(NetPacket.notify_change_room_result);
		...
		MessageMap.addMsgMap(NetPacket.zjh_card_item);
		MessageMap.addMsgMap(NetPacket.zjh_role_item);
		MessageMap.addMsgMap(NetPacket.zjh_game_role_info);
		MessageMap.addMsgMap(NetPacket.req_zjh_prepare);
		MessageMap.addMsgMap(NetPacket.req_zjh_allin);
		MessageMap.addMsgMap(NetPacket.req_zjh_see_cards);
		MessageMap.addMsgMap(NetPacket.req_zjh_apply_compare);
		MessageMap.addMsgMap(NetPacket.req_zjh_compare_role);
		MessageMap.addMsgMap(NetPacket.req_zjh_follow);
		MessageMap.addMsgMap(NetPacket.req_zjh_add_bet);
		MessageMap.addMsgMap(NetPacket.req_zjh_give_up);
		MessageMap.addMsgMap(NetPacket.notify_zjh_card_item);
		MessageMap.addMsgMap(NetPacket.notify_zjh_room_info);
		MessageMap.addMsgMap(NetPacket.notify_zjh_game_start);
		MessageMap.addMsgMap(NetPacket.notify_zjh_round_update);
		MessageMap.addMsgMap(NetPacket.notify_zjh_see_cards);
		MessageMap.addMsgMap(NetPacket.notify_zjh_start_counting);
		MessageMap.addMsgMap(NetPacket.notify_zjh_allin);
		MessageMap.addMsgMap(NetPacket.notify_zjh_apply_compare);
		MessageMap.addMsgMap(NetPacket.notify_zjh_compare);
		MessageMap.addMsgMap(NetPacket.notify_zjh_follow);
		MessageMap.addMsgMap(NetPacket.notify_zjh_add_bet);
		MessageMap.addMsgMap(NetPacket.notify_zjh_give_up);
		MessageMap.addMsgMap(NetPacket.notify_zjh_operator_role);
		MessageMap.addMsgMap(NetPacket.zjh_settlement_item);
		MessageMap.addMsgMap(NetPacket.notify_zjh_settlement);
		MessageMap.addMsgMap(NetPacket.dn_card_item);
		MessageMap.addMsgMap(NetPacket.dn_role_item);
		MessageMap.addMsgMap(NetPacket.dn_game_role_info);
		MessageMap.addMsgMap(NetPacket.notify_dn_room_info);
		MessageMap.addMsgMap(NetPacket.req_dn_prepare);
		MessageMap.addMsgMap(NetPacket.notify_dn_start_counting);
		MessageMap.addMsgMap(NetPacket.notify_dn_game_start);
		MessageMap.addMsgMap(NetPacket.notify_dn_show_card);
		MessageMap.addMsgMap(NetPacket.req_dn_rob_banker);
		MessageMap.addMsgMap(NetPacket.notify_dn_rob_banker);
		MessageMap.addMsgMap(NetPacket.notify_dn_rob_banker_result);
		MessageMap.addMsgMap(NetPacket.req_dn_bet_times);
		MessageMap.addMsgMap(NetPacket.notify_dn_bet_times);
		MessageMap.addMsgMap(NetPacket.notify_dn_all_cards);
		MessageMap.addMsgMap(NetPacket.notify_dn_select_cards_start);
		MessageMap.addMsgMap(NetPacket.req_dn_select_cards);
		MessageMap.addMsgMap(NetPacket.notify_dn_select_cards);
		MessageMap.addMsgMap(NetPacket.dn_settlement_item);
		MessageMap.addMsgMap(NetPacket.notify_dn_settlement);
		MessageMap.addMsgMap(NetPacket.dot21_card_item);
		MessageMap.addMsgMap(NetPacket.dot21_role_item);
		MessageMap.addMsgMap(NetPacket.dot21_game_role_info);
		MessageMap.addMsgMap(NetPacket.notify_dot21_room_info);
		MessageMap.addMsgMap(NetPacket.notify_dot21_start_counting);
		MessageMap.addMsgMap(NetPacket.req_dot21_bet);
		MessageMap.addMsgMap(NetPacket.notify_dot21_bet);
		MessageMap.addMsgMap(NetPacket.dot21_role_with_card);
		MessageMap.addMsgMap(NetPacket.notify_dot21_game_start);
		MessageMap.addMsgMap(NetPacket.req_dot21_buy_insurance);
		MessageMap.addMsgMap(NetPacket.notify_dot21_buy_insurance);
		MessageMap.addMsgMap(NetPacket.req_dot21_divide_card);
		MessageMap.addMsgMap(NetPacket.notify_dot21_divide_card);
		MessageMap.addMsgMap(NetPacket.req_dot21_get_card);
		MessageMap.addMsgMap(NetPacket.notify_dot21_get_card);
		MessageMap.addMsgMap(NetPacket.req_dot21_stop_card);
		MessageMap.addMsgMap(NetPacket.notify_dot21_stop_card);
		MessageMap.addMsgMap(NetPacket.req_dot21_double_card);
		MessageMap.addMsgMap(NetPacket.notify_dot21_double_card);
		MessageMap.addMsgMap(NetPacket.notify_dot21_banker_first_card);
		MessageMap.addMsgMap(NetPacket.notify_dot21_banker_all_cards);
		MessageMap.addMsgMap(NetPacket.dot21_settlement_item);
		MessageMap.addMsgMap(NetPacket.notify_buy_insurance_settlement);
		MessageMap.addMsgMap(NetPacket.notify_dot21_settlement);
		MessageMap.addMsgMap(NetPacket.niu100_pool_info_item);
		MessageMap.addMsgMap(NetPacket.niu100_history_item);
		MessageMap.addMsgMap(NetPacket.notify_niu100_room_info);
		MessageMap.addMsgMap(NetPacket.notify_niu100_start_counting);
		MessageMap.addMsgMap(NetPacket.notify_niu100_start_beting);
		MessageMap.addMsgMap(NetPacket.niu100_settlement_item);
		MessageMap.addMsgMap(NetPacket.notify_niu100_myself_get_money);
		MessageMap.addMsgMap(NetPacket.notify_niu100_start_comparing);
		MessageMap.addMsgMap(NetPacket.niu100_bet_item);
		MessageMap.addMsgMap(NetPacket.req_niu100_bet);
		MessageMap.addMsgMap(NetPacket.notify_niu100_self_bet);
		MessageMap.addMsgMap(NetPacket.notify_niu100_bet);
		MessageMap.addMsgMap(NetPacket.req_niu100_banker_list);
		MessageMap.addMsgMap(NetPacket.notify_niu100_banker_list);
		MessageMap.addMsgMap(NetPacket.req_niu100_banker_in);
		MessageMap.addMsgMap(NetPacket.notify_niu100_banker_in);
		MessageMap.addMsgMap(NetPacket.req_niu100_banker_out);
		MessageMap.addMsgMap(NetPacket.notify_niu100_banker_out);
		MessageMap.addMsgMap(NetPacket.notify_niu100_cur_banker);
		MessageMap.addMsgMap(NetPacket.bjl_pool_info_item);
		MessageMap.addMsgMap(NetPacket.bjl_history_item);
		MessageMap.addMsgMap(NetPacket.bjl_history_point_item);
		MessageMap.addMsgMap(NetPacket.notify_bjl_room_info);
		MessageMap.addMsgMap(NetPacket.notify_bjl_start_counting);
		MessageMap.addMsgMap(NetPacket.notify_bjl_start_beting);
		MessageMap.addMsgMap(NetPacket.bjl_settlement_item);
		MessageMap.addMsgMap(NetPacket.notify_bjl_myself_get_money);
		MessageMap.addMsgMap(NetPacket.notify_bjl_start_comparing);
		MessageMap.addMsgMap(NetPacket.bjl_bet_item);
		MessageMap.addMsgMap(NetPacket.req_bjl_bet);
		MessageMap.addMsgMap(NetPacket.notify_bjl_self_bet);
		MessageMap.addMsgMap(NetPacket.notify_bjl_bet);
		MessageMap.addMsgMap(NetPacket.req_bjl_banker_list);
		MessageMap.addMsgMap(NetPacket.notify_bjl_banker_list);
		MessageMap.addMsgMap(NetPacket.req_bjl_banker_in);
		MessageMap.addMsgMap(NetPacket.notify_bjl_banker_in);
		MessageMap.addMsgMap(NetPacket.req_bjl_banker_out);
		MessageMap.addMsgMap(NetPacket.notify_bjl_banker_out);
		MessageMap.addMsgMap(NetPacket.notify_bjl_cur_banker);
		MessageMap.addMsgMap(NetPacket.bullet_item);
		MessageMap.addMsgMap(NetPacket.cannon_item);
		MessageMap.addMsgMap(NetPacket.buyu_fish_item);
		MessageMap.addMsgMap(NetPacket.notify_buyu_room_info);
		MessageMap.addMsgMap(NetPacket.req_buyu_shoot);
		MessageMap.addMsgMap(NetPacket.notify_buyu_shoot);
		MessageMap.addMsgMap(NetPacket.req_buyu_update_cannon_times);
		MessageMap.addMsgMap(NetPacket.notify_buyu_update_cannon_times);
		MessageMap.addMsgMap(NetPacket.req_buyu_hit_fish);
		MessageMap.addMsgMap(NetPacket.notify_buyu_hit_fish);
		MessageMap.addMsgMap(NetPacket.notify_buyu_fish_spawn);
		MessageMap.addMsgMap(NetPacket.notify_buyu_change_map);
		MessageMap.addMsgMap(NetPacket.req_buyu_target_fish);
		MessageMap.addMsgMap(NetPacket.notify_buyu_target_fish);
		MessageMap.addMsgMap(NetPacket.texas_role_item);
		MessageMap.addMsgMap(NetPacket.texas_game_role_info);
		MessageMap.addMsgMap(NetPacket.req_texas_prepare);
		MessageMap.addMsgMap(NetPacket.req_texas_allin);
		MessageMap.addMsgMap(NetPacket.req_texas_see_cards);
		MessageMap.addMsgMap(NetPacket.req_texas_apply_compare);
		MessageMap.addMsgMap(NetPacket.req_texas_compare_role);
		MessageMap.addMsgMap(NetPacket.req_texas_follow);
		MessageMap.addMsgMap(NetPacket.req_texas_add_bet);
		MessageMap.addMsgMap(NetPacket.req_texas_give_up);
		MessageMap.addMsgMap(NetPacket.texas_card_item);
		MessageMap.addMsgMap(NetPacket.notify_texas_card_item);
		MessageMap.addMsgMap(NetPacket.notify_texas_room_info);
		MessageMap.addMsgMap(NetPacket.notify_texas_game_start);
		MessageMap.addMsgMap(NetPacket.notify_texas_round_update);
		MessageMap.addMsgMap(NetPacket.notify_texas_see_cards);
		MessageMap.addMsgMap(NetPacket.notify_texas_start_counting);
		MessageMap.addMsgMap(NetPacket.notify_texas_allin);
		MessageMap.addMsgMap(NetPacket.notify_texas_apply_compare);
		MessageMap.addMsgMap(NetPacket.notify_texas_compare);
		MessageMap.addMsgMap(NetPacket.notify_texas_follow);
		MessageMap.addMsgMap(NetPacket.notify_texas_add_bet);
		MessageMap.addMsgMap(NetPacket.notify_texas_give_up);
		MessageMap.addMsgMap(NetPacket.texas_settlement_item);
		MessageMap.addMsgMap(NetPacket.notify_texas_settlement);
		...
		MessageMap.addMsgMap(NetPacket.bmw_pool_info_item);
		MessageMap.addMsgMap(NetPacket.notify_bmw_room_info);
		MessageMap.addMsgMap(NetPacket.notify_bmw_start_counting);
		MessageMap.addMsgMap(NetPacket.notify_bmw_start_beting);
		MessageMap.addMsgMap(NetPacket.notify_bmw_myself_get_money);
		MessageMap.addMsgMap(NetPacket.bmw_win_rank_item);
		MessageMap.addMsgMap(NetPacket.notify_bmw_start_comparing);
		MessageMap.addMsgMap(NetPacket.bmw_bet_item);
		MessageMap.addMsgMap(NetPacket.req_bmw_bet);
		MessageMap.addMsgMap(NetPacket.notify_bmw_self_bet);
		MessageMap.addMsgMap(NetPacket.notify_bmw_bet);
		MessageMap.addMsgMap(NetPacket.req_bmw_banker_list);
		MessageMap.addMsgMap(NetPacket.notify_bmw_banker_list);
		MessageMap.addMsgMap(NetPacket.req_bmw_banker_in);
		MessageMap.addMsgMap(NetPacket.notify_bmw_banker_in);
		MessageMap.addMsgMap(NetPacket.req_bmw_banker_out);
		MessageMap.addMsgMap(NetPacket.notify_bmw_banker_out);
		MessageMap.addMsgMap(NetPacket.notify_bmw_cur_banker);
		...
		MessageMap.addMsgMap(NetPacket.zjh100_pool_info_item);
		MessageMap.addMsgMap(NetPacket.zjh100_history_item);
		MessageMap.addMsgMap(NetPacket.notify_zjh100_room_info);
		MessageMap.addMsgMap(NetPacket.notify_zjh100_start_counting);
		MessageMap.addMsgMap(NetPacket.notify_zjh100_start_beting);
		MessageMap.addMsgMap(NetPacket.zjh100_settlement_item);
		MessageMap.addMsgMap(NetPacket.notify_zjh100_myself_get_money);
		MessageMap.addMsgMap(NetPacket.notify_zjh100_start_comparing);
		MessageMap.addMsgMap(NetPacket.zjh100_bet_item);
		MessageMap.addMsgMap(NetPacket.req_zjh100_bet);
		MessageMap.addMsgMap(NetPacket.notify_zjh100_self_bet);
		MessageMap.addMsgMap(NetPacket.notify_zjh100_bet);
		MessageMap.addMsgMap(NetPacket.req_zjh100_banker_list);
		MessageMap.addMsgMap(NetPacket.notify_zjh100_banker_list);
		MessageMap.addMsgMap(NetPacket.req_zjh100_banker_in);
		MessageMap.addMsgMap(NetPacket.notify_zjh100_banker_in);
		MessageMap.addMsgMap(NetPacket.req_zjh100_banker_out);
		MessageMap.addMsgMap(NetPacket.notify_zjh100_banker_out);
		MessageMap.addMsgMap(NetPacket.notify_zjh100_cur_banker);
		MessageMap.addMsgMap(NetPacket.req_mobile_cancel);
		MessageMap.addMsgMap(NetPacket.notify_mobile_cancel);
		MessageMap.addMsgMap(NetPacket.laba_item);
		MessageMap.addMsgMap(NetPacket.notify_laba_room_info);
		MessageMap.addMsgMap(NetPacket.req_laba);
		MessageMap.addMsgMap(NetPacket.notify_laba);
		...
		MessageMap.addMsgMap(NetPacket.notify_buyu_shoot_list);
		...
		MessageMap.addMsgMap(NetPacket.fqzs_pool_info_item);
		MessageMap.addMsgMap(NetPacket.notify_fqzs_room_info);
		MessageMap.addMsgMap(NetPacket.notify_fqzs_start_counting);
		MessageMap.addMsgMap(NetPacket.notify_fqzs_start_beting);
		MessageMap.addMsgMap(NetPacket.notify_fqzs_myself_get_money);
		MessageMap.addMsgMap(NetPacket.fqzs_win_rank_item);
		MessageMap.addMsgMap(NetPacket.notify_fqzs_start_comparing);
		MessageMap.addMsgMap(NetPacket.fqzs_bet_item);
		MessageMap.addMsgMap(NetPacket.req_fqzs_bet);
		MessageMap.addMsgMap(NetPacket.notify_fqzs_self_bet);
		MessageMap.addMsgMap(NetPacket.notify_fqzs_bet);
		MessageMap.addMsgMap(NetPacket.req_fqzs_banker_list);
		MessageMap.addMsgMap(NetPacket.notify_fqzs_banker_list);
		MessageMap.addMsgMap(NetPacket.req_fqzs_banker_in);
		MessageMap.addMsgMap(NetPacket.notify_fqzs_banker_in);
		MessageMap.addMsgMap(NetPacket.req_fqzs_banker_out);
		MessageMap.addMsgMap(NetPacket.notify_fqzs_banker_out);
		MessageMap.addMsgMap(NetPacket.notify_fqzs_cur_banker);
		MessageMap.addMsgMap(NetPacket.notify_fqzs_bank_list_have_real_player);
