...
export module NetPacket {
	...
	export function req_first_recharge_status() {
		let tb: any = {
			getMsgID: function () {
			...
			build: function (buf: any) {
				EncodeUtils.uInt32ToByte(NetMsgType.msgType["msg_req_first_recharge_status"], buf);
				return tb.encode(buf);
			}
		};
		return tb;
	}
	export function notify_first_recharge_status() {
		let tb: any = {
			status: 0,
			getMsgID: function () {
				return NetMsgType.msgType["msg_notify_first_recharge_status"];
			},
			encode: function (buf: any) {
				EncodeUtils.int32ToByte(tb.status, buf);
			},
			...
			build: function (buf: any) {
				EncodeUtils.uInt32ToByte(NetMsgType.msgType["msg_notify_first_recharge_status"], buf);
				return tb.encode(buf);
			}
		};
		return tb;
	...
	export function req_get_games_by_kind() {
		let tb: any = {
			kindId: 0,
			page: 0,
			pageSize: 0,
			inner_size: 0,
			getMsgID: function () {
				return NetMsgType.msgType["msg_req_get_games_by_kind"];
			},
			encode: function (buf: any) {
				EncodeUtils.int32ToByte(tb.kindId, buf);
				EncodeUtils.int32ToByte(tb.page, buf);
				EncodeUtils.int32ToByte(tb.pageSize, buf);
				EncodeUtils.int32ToByte(tb.inner_size, buf);
			},
			decode: function (buf: any, index: number) {
				let startIndex = index;
				tb.kindId = EncodeUtils.ByteToint32(buf, startIndex);
				...
				tb.pageSize = EncodeUtils.ByteToint32(buf, startIndex);
				startIndex += 4;
				tb.inner_size = EncodeUtils.ByteToint32(buf, startIndex);
				startIndex += 4;
				return startIndex - index;
			},
			build: function (buf: any) {
				EncodeUtils.uInt32ToByte(NetMsgType.msgType["msg_req_get_games_by_kind"], buf);
				return tb.encode(buf);
			}
		};
		return tb;
	}
	export function platform_info() {
		let tb: any = {
			agentId: 0,
			info: [],
			getMsgID: function () {
				return NetMsgType.msgType["msg_platform_info"];
			},
			encode: function (buf: any) {
				EncodeUtils.int32ToByte(tb.agentId, buf);
				EncodeUtils.uInt16ToByte(tb.info.length, buf);
			...
			build: function (buf: any) {
				EncodeUtils.uInt32ToByte(NetMsgType.msgType["msg_platform_info"], buf);
				return tb.encode(buf);
			}
		};
		return tb;
	}
	export function notify_get_games_by_kind() {
		let tb: any = {
			total: 0,
			info: [],
			getMsgID: function () {
				return NetMsgType.msgType["msg_notify_get_games_by_kind"];
			},
			encode: function (buf: any) {
				EncodeUtils.int32ToByte(tb.total, buf);
				EncodeUtils.uInt16ToByte(tb.info.length, buf);
			...
			build: function (buf: any) {
				EncodeUtils.uInt32ToByte(NetMsgType.msgType["msg_notify_get_games_by_kind"], buf);
				return tb.encode(buf);
			}
		};
		return tb;
