export default {
  ...
  paymentManagement_page_max_usdt: '每个用户最多添加6个地址，您已填写{num}个',
  paymentManagement_page_new_usdt: '添加USDT地址',
  paymentManagement_page_address: '地址',
  paymentManagement_page_remark: '备注',
  paymentManagement_page_oneUsdt: '至少添加一个USDT地址',
  paymentManagement_page_usdt_tips: '请输入USDT地址',
  paymentManagement_page_usdt_describe: '描述(选填)',
  ...
  activity_page_signIn: '签到',
  activity_page_reSignIn: '补签',
  activity_page_tip: '温馨提示',
  activity_page_keepBet: '继续投注',
  activity_page_knowed: '知道了',
  activity_page_confirmGet: '确定领取',
  activity_page_sevenDays: '7日满签、月满签可额外获得嘉奖礼金！',
  activity_page_todayBet: '今日有效投注额',
  activity_page_canGet: '当前可领取彩金',
  activity_page_nextCanGet: '下级可领取彩金',
  activity_page_maxCanGet: '最高可领取彩金',
  activity_page_goBet: '立即投注',
  activity_page_goSign: '立即签到',
  activity_page_stopTime: '距今日有效投注额统计截止',
  activity_page_dayBet: '每日有效投注额',
  activity_page_dayPrize: '单日奖励',
  activity_page_weekPrize: '7日奖励',
  activity_page_monthPrize: '28日奖励',
  activity_page_signTips_1: '1.本活动以自然月单位为一个周期',
  activity_page_signTips_2: '2.在活动周期，按照日签到、7日连续签、28日连续签到进行统计，会员当日有效投注额达到≥2,000即可在活动页面手动签到，完成签到后系统将自动发放相应签到礼金至福利中心，自然月内达成7日连续签到即可获得周满签额外奖励，自然月内达成28日连续签到即可获得月满签额外奖励；',
  activity_page_signTips_3: '3.例：会员A自然月内连续7天单日有效投注额均≥50,000，即可获得128+128+128+128+128+128+128+388=1,284元签到礼金。',
  activity_page_signTips_4: '4.周满签及月满签奖励将按照最低档位奖励发放礼金；',
  activity_page_signTips_5: '5.签到礼金不限场馆，签到成功后，自动发放至我的优惠，福利中心领取彩金三日内有效，含发放当日，逾期领取将失效不予补偿，礼金仅需1倍流水即可提款；',
  activity_page_signTips_6: '6.已领取月满签奖励的会员，可以继续参与签到活动，领取单日签到奖励，直到自然月结束；',
  activity_page_signTips_7: '7.为避免数据延迟，建议在每日23:30之前完成签到，若数据延迟导致无法签到，将不予补发；',
  activity_page_signTips_8: '8.玩家忘记签到可以补签，必须先完成当日签到任务才能进行补签，补签需满足补签有效投注额；',
  activity_page_signTips_9: '9.活动仅对已结算并产生输赢结果的投注额进行计算，任何走水、串关、提前结算的投注、取消的赛事将不计算在有效投注。',
  activity_page_signTips_10: '10.参与本优惠前需完善个人信息，绑定银行卡等信息，且每位有效玩家、每一手机号码、电子邮箱、相同银行卡、每一个IP地址、每一台电脑使用者在活动期间每天仅可享受一次签到礼金优惠，如会员使用一切不正常投注、套利等违规行为，我们将保留无限期审核扣回礼金及所产生的利润权利；',
  activity_page_signTips_11: '11.为避免文字理解差异，PKbet保留本活动最终解释权。',
  activity_page_award: '奖励',
  activity_page_illustrate: '说明',
  activity_page_todayAllBet: '今日累计有效投注额',
  activity_page_canGift: '可领取彩金',
  activity_page_useBet: '消耗有效投注额',
  activity_page_avBet: '剩余有效投注额',
  activity_page_finishRe: '补签完成，彩金 {num} 已派发',
  activity_page_onlyBet: '今日剩余有效投注额',
  activity_page_needBet: '有效投注额还需完成',
  activity_page_failSign: '签到失败，还需完成对应的有效投注额，才可签到成功',
  activity_page_needSign: '要先完成今日签到才能补签哦！',
  activity_page_failReSign: '补签失败，还需完成对应的有效投注额，才可补签成功',
}
