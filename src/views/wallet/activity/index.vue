<template>
    <div class="activity">
        ...
        <div class="tab">
            <span :class="state.active == i ? 'active' : ''" v-for="(game, g, i) in activityTitleList" :key="i"
                @click="changeTab(i)">{{
                    t(g) }}</span>
        </div>
        <div class="img_box">
        ...
        >div {
            ...
            >p {
                ...
                >span {
                    ...
                    display: flex;
                    align-items: center;
                    background: linear-gradient(180deg, #F7DC82 0%, #CA8528 100%), linear-gradient(180deg, #F7DC82 0%, #A76712 100%);
